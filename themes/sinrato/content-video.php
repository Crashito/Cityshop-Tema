				...
				<?php if (do_shortcode(get_post_meta( $post->ID, '_sinrato_post_intro', true )) != '') { ?>
					<div class="post-thumbnail-wrapper">
						<div class="post-thumbnail">
							<?php echo do_shortcode(get_post_meta( $post->ID, '_sinrato_post_intro', true )); ?>
							<?php if(has_category()) { ?>
					...
					<?php if(get_the_author_meta()!="") { ?>
						<div class="author-info">
							...
							<div class="author-description">
								<h2><?php esc_html__( 'About the Author:', 'sinrato'); printf( '<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" rel="author">%s</a>' , get_the_author()); ?></h2>
